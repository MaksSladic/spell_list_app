    ...
    <body>
        <div class="container-fluid">
            <div class="row bg-secondary">
                ...
                <div class="col-sm-1 col-md-1 col-lg-1 text-center">
                    <Form action="http://localhost/spell_list_app/web_page/AllSpells.php" method="POST">
                        <button type="submit" class="btn btn-primary border border-dark text-center">All spells</button>
                    </Form>
                </div>
                <div class="col-sm-1 col-md-1 col-lg-1 text-center">
                    <Form action="http://localhost/spell_list_app/web_page/index.php" method="POST">
                ...
                <div class="col-sm-1 col-md-1 col-lg-1 offset-7 text-center">
                    <Form action="http://localhost/spell_list_app/web_page/login.php" method="POST">
                        <button type="submit" class="btn btn-primary border border-dark">Login</button> 
                    </Form>
                </div>
                <div class="col-sm-1 col-md-1 col-lg-1 text-center">
                    <Form action="http://localhost/spell_list_app/web_page/signup.php" method="POST">
        ...
        <div class="container bg-info" style="margin:5%">  
            <div class="row" id="Table" style = "margin:10px">
