...
<html lang="en">
    ...
    <body onload="DefaultValue()">
        ...
        <div class="container">
            <p class="text-center font-weight-bold">Name your character</p>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-1 col-md-1 col-lg-1 text-center">
                        <button onclick="createCharacter()" class="btn btn-primary border border-dark text-center">Save</button>
                    </div>
                </div>
            </div>
        </div>
